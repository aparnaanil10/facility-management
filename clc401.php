...
$date=$_POST['date'];
   ...
   $sql = "SELECT * FROM clc401 WHERE date = '$date' AND ((start_time <= '$start_time' AND end_time >= '$start_time') OR (start_time <= '$end_time' AND end_time >= '$end_time'))";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql1 = "INSERT INTO clc401 ( name, email, phone_no,department,purpose,start_time, end_time,date) VALUES ('$name','$email', '$phone_no', '$department','$purpose','$start_time', '$end_time','$date')";
		         
		$sql2 = "INSERT INTO bookings (facility, date, start_time, end_time, department, purpose, name, email) 
         VALUES ('CLC 401', '$date', '$start_time', '$end_time', '$department','$purpose', '$name', '{$_SESSION['user_email']}')";
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex mx-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="seminaraudit.php"> Booking </a>
                </li>
              </ul>
            </div>
...
<div class="form">
<img src="clc.png" alt="Image" class="form-image">

<div>
<b><center><h3>BOOK YOUR SLOT <br>CLC 401</b><BR></h3>
...
$mail = new PHPMailer;
$mail= new PHPMailer();
$body= "You are booked for ".$date."<br>Your booking has been confirmed for clc401.<br> For further queries or clarifications visit our site.<br> If you want to cancel the booking please conatct admins atleast 3 days prior to the event.";
...
$mail->AltBody    = "Your booking has been confirmed for clc401.<br> For further queries or clarifications visit our site.<br> If you want to cancel the booking please conatct admins atleast 3 days prior to the event.";
