...
<head>
  ...
  <!-- fonts style -->
  <link href="https://fonts.googleapis.com/css?family=Poppins:400,600,700&disvb303ay=swap" rel="stylesheet">
  <!-- Custom styles for this temvb303ate -->
...
$date=$_POST['date'];
   ...
   $sql = "SELECT * FROM vb303 WHERE date = '$date' AND ((start_time <= '$start_time' AND end_time >= '$start_time') OR (start_time <= '$end_time' AND end_time >= '$end_time'))";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql1 = "INSERT INTO vb303 (name, email, phone_no,start_time, end_time,purpose,department,date) VALUES ('$name','$email', '$phone_no', '$start_time', '$end_time','$purpose','$department','$date')";
		
		$sql2 = "INSERT INTO bookings (facility, date, start_time, end_time, department, purpose, name, email) 
         VALUES ('VB 303', '$date', '$start_time', '$end_time', '$department', '$purpose', '$name', '{$_SESSION['user_email']}')";
...
<div class="form">
<img src="vb.png" alt="Image" class="form-image">

<div>
<b><center><h3>BOOK YOUR SLOT <br>VB 303</b><BR></h3>
...
$mail = new PHPMailer;
$mail= new PHPMailer();
$body= "You are booked for ".$date."<br>Your booking has been confirmed for VB 303.";

//$body= eregi_revb303ace("[\]",'',$body);
...
//$mail->AddRevb303yTo($email, 'First Last');

$mail->Subject    = "Booking Confirmation";

$mail->AltBody    = "Your booking has been confirmed for VB 303.<br> For further queries or clarifications visit our site.<br> If you want to cancel the booking vb303ease conatct admins atleast 3 days prior to the event.";
