...
$date=$_POST['date'];
   ...
   $sql = "SELECT * FROM ab201 WHERE date = '$date' AND ((start_time <= '$start_time' AND end_time >= '$start_time') OR (start_time <= '$end_time' AND end_time >= '$end_time'))";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql1 = "INSERT INTO ab201 (name, email, phone_no,start_time, end_time,purpose,department,date) VALUES ('$name','$email', '$phone_no', '$start_time', '$end_time','$purpose','$department','$date')";
		
		$sql2 = "INSERT INTO bookings (facility, date, start_time, end_time, department, purpose, name, email) 
         VALUES ('ab201', '$date', '$start_time', '$end_time', '$department', '$purpose', '$name', '{$_SESSION['user_email']}')";
...
<div>
<b><center><h3>BOOK YOUR SLOT <br>	AB 201</b><BR></h3>
...
$mail = new PHPMailer;
$mail= new PHPMailer();
$body= "You are booked for ".$date."<br>Your booking has been confirmed for AB 201.<br>";
...
$mail->AltBody    = "Your reservation for NB 101 has been successfully <b>waitlisted</b>. For any inquiries or clarification, please visit our website. In the event that you need to cancel your booking, kindly contact our administrators at least 3 days prior to the scheduled event. Thank you for choosing us, and we look forward to hosting you!";
$mail->MsgHTML($body);
