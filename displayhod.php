...
<body>
  ...
  <div class="hero_area">
    ...
    <form action="" method="post">
      <center>
        <label for="dept"><b>Choose a department:</label>
        ...
        <label for="halls"><b>Choose a facility:</label>
    ...
    if (isset($_POST["submit"])) {
      ...
      $sql = "SELECT * FROM $halls where department= $departement;";
      ...
      if (mysqli_num_rows($result) > 0) {
            echo "<table class='darkTable' border='0' cellspacing='2' cellpadding='2'><tr><th>NAME</th><th>DEPARTMENT</th><th>DATE</th><th>PHONE NUMBER</th><th>START TIME</th><th>END TIME</th><th>PURPOSE</TH><th>CONTACT </th><th>APPROVE/DELETE</th>";
            while($row = mysqli_fetch_assoc($result))
            {
              ...
              echo "<tr><td>" . $row["name"]. "</td><td>" . $row["department"]. "</td><td>" . $row["date"]."</td><td>".$row["phone_no"]."</td><td>" . $row["start_time"]. "</td><td>" . $row["end_time"]. "</td><td>" . $row["purpose"]. "</td><td>"."<a href='mailto:$email'>$email</a>"."</td><td>"."<form action='C:\xampp\htdocs\miniproject\approve.php' method='post'>"."<form action='C:\xampp\htdocs\miniproject\delete.php' method='post'>"."<form action='C:\xampp\htdocs\miniproject\delete.php' method='post'>".
