...
$date=$_POST['date'];
   ...
   $sql = "SELECT * FROM pl WHERE date = '$date' AND ((start_time <= '$start_time' AND end_time >= '$start_time') OR (start_time <= '$end_time' AND end_time >= '$end_time'))";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql1 = "INSERT INTO pl (name, email, phone_no,start_time, end_time,purpose,department,date) VALUES ('$name','$email', '$phone_no', '$start_time', '$end_time','$purpose','$department','$date')";
		
		$sql2 = "INSERT INTO bookings (facility, date, start_time, end_time, department, purpose, name, email) 
         VALUES ('Programming Lab', '$date', '$start_time', '$end_time', '$department', '$purpose', '$name', '{$_SESSION['user_email']}')";
...
<div>
<b><center><h3>BOOK YOUR SLOT <br>PROGRAMMING LAB</b><BR></h3>
<table align="center">
...
$mail = new PHPMailer;
$mail= new PHPMailer();
$body= "You are booked for ".$date."<br>Your booking has been confirmed for PROGRAMMING LAB.";
...
$mail->AltBody    = "Your booking has been confirmed for PROGRAMMING LAB.<br> For further queries or clarifications visit our site.<br> If you want to cancel the booking please conatct admins atleast 3 days prior to the event.";
