...
$date=$_POST['date'];
   ...
   $sql = "SELECT * FROM miniaudit WHERE date = '$date' AND ((start_time <= '$start_time' AND end_time >= '$start_time') OR (start_time <= '$end_time' AND end_time >= '$end_time'))";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO miniaudit (name, email, phone_no,start_time, end_time,purpose,department,date) VALUES ('$name','$email', '$phone_no', '$start_time', '$end_time','$purpose','$department','$date')";
...
<div class="form">
<img src="miniaudit.png" alt="Image" class="form-image">

<div>
<b><center><h3>BOOK YOUR SLOT <br>MINI AUDITORIUM</b><BR></h3>
...
$mail = new PHPMailer;
$mail= new PHPMailer();
$body= "You are booked for ".$date."<br>Your booking has been confirmed for Mini Auditorium.";
...
$mail->AltBody    = "Your booking has been confirmed for Mini Auditorium.<br> For further queries or clarifications visit our site.<br> If you want to cancel the booking please conatct admins atleast 3 days prior to the event.";
